...
/*  server to the management client in  */
...
#define C_OK    12  /* A response to an C_RESTART,    */
/*  C_RESTART_NODES, C_XOFF, C_XON, */
/*  C_OFFLINE, C_ONLINE, or C_NEW_TOP */
/*  that indicates success.   */

#define C_ERR   13  /* A response sent by a node when  an */
